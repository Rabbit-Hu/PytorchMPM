...
output_dir = '/xiaodi-fast-vol/PytorchMPM/learnable/learn_Psi/data/jelly_v2_ever_iter'
os.makedirs(output_dir, exist_ok=True)

num_configs = 1 # Number of configurations (E, nu)
num_trajs_train, num_trajs_val = 10, 1 # Number of trajectories
max_frames = 1000
